              ...
              <div className="ftco-footer-widget mb-4">
                ...
                <div className="block-23 mb-3">
                  <ul>
                    ...
                    <li><Link to="#"><span className="icon icon-phone"></span><span className="text">9837570302</span></Link></li>
                    <li><Link to="#"><span className="icon icon-envelope"></span><span className="text"> jsingh22063@gmail.com</span></Link></li>
                  </ul>
                </div>
              </div>
            </div>
